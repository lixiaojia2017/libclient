...
([
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var PDFViewerApplication = {
            ...
            bindEvents: function bindEvents() {
                ...
                eventBus.on('addbookmark', webViewerAddBookMark);
            ...
            unbindEvents: function unbindEvents() {
                ...
                eventBus.off('addbookmark', webViewerAddBookMark);
        ...
        var webViewerFileInputChange = void 0; {
            webViewerFileInputChange = function webViewerFileInputChange(evt) {
                ...
                var appConfig = PDFViewerApplication.appConfig;
                appConfig.toolbar.viewBookmark.setAttribute('style', '');
        ...
        function bookmarkOnclick() {
            let pg = this.getAttribute('pagenum');
            PDFViewerApplication.pdfLinkService.page = pg - 0;
        }

        function renderBookmarkviewer(page, isSet) {
            let view = document.getElementById('bookmarksView');
            let childs = view.childNodes;
            if (isSet) {
                let element = document.createElement('div');
                element.setAttribute('class', 'attachmentsItem');
                element.setAttribute('pageNum', page);
                let btn = document.createElement('button');
                btn.setAttribute('pageNum', page);
                btn.onclick = bookmarkOnclick;
                btn.innerHTML = 'Page: ' + page;
                ...
                if (childs.length == 1) {
                    ...
                    let nodeNum = childs[1].getAttribute('pageNum');
                    if (nodeNum < page) {
                        view.appendChild(element);
                    }
                    else {
                        view.insertBefore(element, childs[1]);
                    }
                }
                else {
                    if (childs[1].getAttribute('pageNum') > page) {
                        view.insertBefore(element, childs[1]);
                        return;
                    }
                    for (let i = 1; i < childs.length; ++i) {
                        if (childs[i].getAttribute('pageNum') < page) {
                            if (i + 1 >= childs.length) {
                                view.appendChild(element);
                                break;
                            }
                            else if (page < childs[i + 1].getAttribute('pageNum')) {
                                view.insertBefore(element, childs[i + 1]);
                                break;
                            }
                        }
                    }
        ...
        function toggleBookmarkButton(tog) {
            var elem = document.getElementById("viewBookmark");
            if (tog) {
                elem.setAttribute('style', 'background-color: hsla(0, 0%, 0%, .2);\
    ...
    border: 1px solid hsla(0, 0%, 0%, .35);');
        ...
        function webViewerAddBookMark() {
            let currPage = PDFViewerApplication.pdfViewer.currentPageNumber - 0;
            let tog;
            if (PDFViewerApplication.currBookmark === null) {
                PDFViewerApplication.currBookmark = new Set([currPage]);
                tog = true;
                qpdfBridge.jsGetBookMarkPage(currPage, true);
            } else {
                if (PDFViewerApplication.currBookmark.has(currPage)) {
                    tog = false;
                    PDFViewerApplication.currBookmark.delete(currPage);
                    qpdfBridge.jsGetBookMarkPage(currPage, false);
                } else {
                    tog = true;
                    PDFViewerApplication.currBookmark.add(currPage);
                    qpdfBridge.jsGetBookMarkPage(currPage, true);
                }
            }
            toggleBookmarkButton(tog);
            renderBookmarkviewer(currPage,tog);
        }
        ...
        function webViewerPageChanging(evt) {
            ...
            if (PDFViewerApplication.currBookmark != null && PDFViewerApplication.currBookmark.has(page - 0)) {
                toggleBookmarkButton(true);
            } else toggleBookmarkButton(false);
            if (PDFViewerApplication.pdfSidebar.isThumbnailViewVisible) {
    ...
    (function(module, exports, __webpack_require__) {
        ...
        var PDFSidebar = function() {
            function PDFSidebar(options) {
                ...
                this.bookmarksButton = options.bookmarksButton;
                this.thumbnailView = options.thumbnailView;
                this.outlineView = options.outlineView;
                this.attachmentsView = options.attachmentsView;
                this.bookmarksView = options.bookmarksView;
            ...
            _createClass(PDFSidebar, [{
                ...
                value: function reset() {
                    ...
                    this.bookmarksButton.disabled = false;
                }
            }, {
                key: 'setInitialView',
                ...
                value: function switchView(view) {
                    ...
                    switch (view) {
                        case SidebarView.THUMBS:
                            ...
                            this.bookmarksButton.classList.remove('toggled');
                        ...
                        case SidebarView.BOOKMARKS:
                            ...
                            this.outlineButton.classList.remove('toggled');
                            this.attachmentsButton.classList.remove('toggled');
                            this.bookmarksButton.classList.add('toggled');
                            this.thumbnailView.classList.add('hidden');
                            this.outlineView.classList.add('hidden');
                            this.attachmentsView.classList.add('hidden');
                ...
                value: function _addEventListeners() {
                    ...
                    this.bookmarksButton.addEventListener('click', function() {
                        _this3.switchView(SidebarView.BOOKMARKS);
                    });
        ...
        var Toolbar = function() {
            ...
            _createClass(Toolbar, [{
                ...
                value: function _bindListeners() {
                    ...
                    items.viewBookmark.addEventListener('click', function() {
                        eventBus.dispatch('addbookmark');
                    });
...
/*
 * The following code is added to allow injecting raw PDF data
 * from the C++ context.
